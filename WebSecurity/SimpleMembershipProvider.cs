...
namespace WebMatrix.WebData
{
    public class SimpleMembershipProvider : ExtendedMembershipProvider
    {
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            if (username.IsEmpty())
            {
                throw new ArgumentException(WebDataResources.Argument_Cannot_Be_Null_Or_Empty, "username");
            }
            if (oldPassword.IsEmpty())
            {
                throw new ArgumentException(WebDataResources.Argument_Cannot_Be_Null_Or_Empty, "oldPassword");
            }
            if (newPassword.IsEmpty())
            {
                throw new ArgumentException(WebDataResources.Argument_Cannot_Be_Null_Or_Empty, "newPassword");
            }
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            if (password.IsEmpty())
            {
                throw new ArgumentException(WebDataResources.Argument_Cannot_Be_Null_Or_Empty, "password");
            }
