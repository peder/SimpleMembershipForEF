        ...
        public OAuthAccountData(string provider, string providerUserId)
        {
            if (String.IsNullOrEmpty(provider))
            {
                throw new ArgumentException(
                    String.Format(CultureInfo.CurrentCulture, WebDataResources.Argument_Cannot_Be_Null_Or_Empty, "provider"),
                    "provider");
            }
            ...
            {
                throw new ArgumentException(
                    String.Format(CultureInfo.CurrentCulture, WebDataResources.Argument_Cannot_Be_Null_Or_Empty, "providerUserId"),
                    "providerUserId");
            }
